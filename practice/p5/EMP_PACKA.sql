CREATE OR REPLACE PACKAGE BODY emp_pack IS
    ...
    FUNCTION valid_deptid(p_dept_id IN departments.department_id%TYPE) RETURN BOOLEAN IS
        v_dummy NUMBER;
    BEGIN
    ...
    BEGIN
        ...
        IF v_valid THEN
            ...
            DBMS_OUTPUT.PUT_LINE('Employee inserted: ' || p_first_name || ' ' || p_last_name);
        ELSE
            DBMS_OUTPUT.PUT_LINE('ERROR: Department ' || p_department || ' does not exist.');
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
